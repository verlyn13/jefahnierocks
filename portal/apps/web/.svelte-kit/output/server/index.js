  ...
  try {
    ...
    if (info.type === "command") {
      ...
      return json(
        /** @type {RemoteFunctionResponse} */
        {
          type: "result",
          result: stringify$1(data2, transport),
          refreshes: stringify$1({ ...get_event_state(event).refreshes, ...refreshed }, transport)
        }
      );
    }
    ...
    if (error2 instanceof Redirect) {
      ...
      return json({
        ...
        refreshes: Object.keys(refreshes).length > 0 ? stringify$1(refreshes, transport) : void 0
      });
    }
    return json(
      /** @type {RemoteFunctionResponse} */
