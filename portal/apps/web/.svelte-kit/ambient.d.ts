...
declare module '$env/static/private' {
	...
	export const MISE_USE_TOML: string;
	...
	export const AZURE_CORE_COLLECT_TELEMETRY: string;
	...
	export const DOTFILES_HOME: string;
	...
	export const WORKSPACE_HOME: string;
	...
	export const DEVELOPMENT_HOME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		AZURE_CORE_COLLECT_TELEMETRY: string;
